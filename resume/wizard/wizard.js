...
// [wizard.js] v2.11.1 — inline editors (match canvas), sidebar toggle, sparkly "Added" animation
console.log('[wizard.js] v2.11.1');
...
function renderStep(){
  ...
  if (s === 'contact'){
    ...
    // FIX: one closing parenthesis removed here
